...
The following example clones the "[Basic Secure Application](https://github.com/Infineon/mtb-example-psoc-edge-basic-secure-app)" application with the desired name "MySecureApp" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-basic-secure-app --user-app-name MySecureApp --target-dir "C:/mtb_projects"
   ```
